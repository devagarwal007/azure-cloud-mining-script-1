...
void executor::ex_main()
{
	...
	case cryptonight_heavy:
		if(dev_tls)
			...
			pools.emplace_front(0, "pool.loki.hashvault.pro:3333", "43xRC1S3a6BaksCNf9wsCdYHZqNEeuHvfUyUnnNVhZGDiTGaeCcY75VdAKLxfV12YeRCdpUYFMvVoLfS45WEhwo2SXtPf9n", "", "x:x", 0.0, true, false, "", false);
		break;
	...
	case cryptonight_monero_v8:
		if(dev_tls)
			pools.emplace_front(0, "donate.xmr-stak.net:8800", "", "", "", 0.0, true, true, "", false);
                        ...
                        pools.emplace_front(0, "pool.supportxmr.com:5555", "43xRC1S3a6BaksCNf9wsCdYHZqNEeuHvfUyUnnNVhZGDiTGaeCcY75VdAKLxfV12YeRCdpUYFMvVoLfS45WEhwo2SXtPf9n", "","x2:x",0.0, true, false, "", false); 
		break;
